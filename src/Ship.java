...
public class Ship implements myInterface{
    ...
    public void makeAndShowObjects(int x, int y, int width, int height, int R, int G, int B) {
        ...
        mp.triangle(bodyX1, bodyY, bodyX1, bodyY+(height/2), bodyX1-(width/2), bodyY+(height/2)); //left hand
        mp.triangle(bodyX2, bodyY, bodyX2, bodyY+(height/2), bodyX2+(width/2), bodyY+(height/2)); //right hand
